...
const PERMISSION_GROUPS = [
  ...
  { label: 'Ficha Personal',         module: 'ficha_personal', actions: ['ver'] },
  { label: 'Cesados',                module: 'cesados',        actions: ['ver'] },
  { label: 'Amonestaciones',         module: 'amonestaciones', actions: ['ver', 'crear', 'editar', 'eliminar'] },
  { label: 'Historial Contratos',    module: 'contratos',      actions: ['ver', 'editar'] },
  { label: 'Contratos de Unidad',    module: 'contratos_unidad', actions: ['ver', 'crear', 'editar', 'eliminar'] },
  ...
  { label: 'Tramas',                 module: 'tramas',         actions: ['ver'] },
  ...
  { label: 'Backups',                module: 'backups',        actions: ['ver', 'crear', 'eliminar'] },
